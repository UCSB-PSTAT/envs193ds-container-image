                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"ggpomological\")"'
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"ggthemes\")"'
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"rstatix\")"'
